...
void ofApp::setup(){
    ...
    //petalImageHovered.loadImage("images/plasticCloves.png");
       petalImageHovered.loadImage("images/LovesMe800.png");
    ...
    end.loadImage("images/end1.png");
    
    //----kasia add timer for end image
...
void ofApp::draw(){
    ...
    if (myFlws.size() == 0 && myFlwSmall.size() == 0 && timer-preTimer > 1000) {
